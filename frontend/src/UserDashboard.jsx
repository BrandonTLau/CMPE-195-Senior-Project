...
{activeTab === "processing" && (
  <ProcessingScreen
    ...
    message={processingState?.message || "Running OCR…"}
    error={processingState?.error || ""}
    onBack={() => {
      setActiveTab("upload");
      if (onCancelProcessing) onCancelProcessing();
    }}
  />
)}

            {/* RESULTS (embedded) */}
            {activeTab === "results" && <ResultsPage ocrResult={ocrResult} />}
